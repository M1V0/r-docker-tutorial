...
## Of Note
This tutorial is made up of a combination of both essential and optional information. Sections or page deemed optional to understanding how to use Docker in a more collaborative sense (such as pushing a Docker image to Docker hub or sharing with colleagues) are marked as optional. The information not marked as optional is core to understanding the way in which one would use Docker initially.
